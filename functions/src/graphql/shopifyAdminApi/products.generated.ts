...
export type GetRecentProductsQueryVariables = Types.Exact<{
  first: Types.Scalars['Int']['input'];
}>;


export type GetRecentProductsQuery = { __typename?: 'QueryRoot', products: { __typename?: 'ProductConnection', edges: Array<{ __typename?: 'ProductEdge', node: { __typename?: 'Product', id: string, title: string, handle: string, featuredImage?: { __typename?: 'Image', url: string } | null, variants: { __typename?: 'ProductVariantConnection', edges: Array<{ __typename?: 'ProductVariantEdge', node: { __typename?: 'ProductVariant', id: string, title: string, price: string } }> } } }> } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    GetRecentProducts(variables: GetRecentProductsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetRecentProductsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRecentProductsQuery>({ document: GetRecentProductsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetRecentProducts', 'query', variables);
    }
  };
}
